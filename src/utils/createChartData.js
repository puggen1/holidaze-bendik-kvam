...
const createChartData = (data) => {
    ...
    const allDays = new Array(new Date().getDate()).fill(0).map((_, index) => {
        ...
        const isGuestDay = guestDays.find((day) => day.date.toISOString().split("T")[0] === current.toISOString().split("T")[0])
